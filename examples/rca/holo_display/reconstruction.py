...
def get_pwi_reconstruction(
    ...
    range_xy, range_yx = __get_frame_ranges(*seqs)
    ap_size_xy, ap_size_yx = __get_rx_aperture_size(*seqs)
...
def to_bmode(dr_name=None, dr_min=20, dr_max=80):
    return (
...
def __get_rx_aperture_size(*seqs):
